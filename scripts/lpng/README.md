...
| `src`        | string  | —          | PNG filename in the zip. Absent ⇒ this layer is a group.              |
...
python psd_to_lpng.py input.psd --optimize      # crop layers to the canvas
