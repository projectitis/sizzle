...
// Lets two slices drawn in their own local coordinates be nudged until their
// dots line up across a shared seam.
...
// [c]/[s] are cos/sin of the rotation; [axis]/[len2] describe the gradient
// axis.
...
void main() {
    ...
    // Into lattice space: shift by the phase offset in screen space, then rotate
